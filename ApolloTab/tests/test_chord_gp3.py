...
运行命令: python -m pytest ApolloTab/tests/test_chord_gp3.py -q

v1.4.1: 移除硬编码 macOS 路径，改用 conftest.py 定位样本目录。
        guitarpro7/ 当前无 .gp3 样本，端到端用例自动 skip。
"""
...
# real_gp3_chords_file fixture 由 conftest.py 提供 (按 guitarpro7/ 下 .gp3 文件解析)
...
def _make_chord(
    ...
    """
    from guitarpro.models import Chord, ChordExtension, ChordType
